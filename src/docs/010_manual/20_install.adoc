...
If you have an Apple Silicon (M1/M2) Mac, make sure that you have docker up and running, rosetta is installed and up-to-date (`softwareupdate --install-rosetta`) and type the following commands in the Terminal:
...
[NOTE]
.docToolchain depends on Java 17
====
