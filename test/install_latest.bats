...
@test "DTC_VERSION=latest tasks - show use of latest version" {
    ...
    assert_equal "$(mock_get_call_args "${mock_doctoolchain}")" ". tasks --warning-mode=none --no-daemon -Dfile.encoding=UTF-8 -PmainConfigFile=docToolchainConfig.groovy -Dorg.gradle.java.home=${DTC_ROOT}/jdk -Dgradle.user.home=${DTC_ROOT}/.gradle"
}
