...
If you're using an AI assistant like ChatGPT or Claude to help with docToolchain, please direct it to read our link:LLM.txt[LLM.txt] file first. This file contains accurate, up-to-date information about docToolchain's installation and usage, which helps AI assistants provide better guidance.
...
a| [link=https://www.dbsystel.de]
image::db-logo.svg[DB Systel, width=50%]

a| [link=https://www.codecentric.de]
image::cclogo.png[codecentric, width=50%]

a| [link=https://www.innoq.com]
...
image::https://resources.jetbrains.com/storage/products/company/brand/logos/jetbrains.svg["IDE Sponsor",link="https://jb.gg/OpenSourceSupport"]
